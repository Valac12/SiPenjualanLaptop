            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between w-100">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a class="navbar-brand d-none d-sm-inline-block" href="index.html">
                  <div class="brand-text d-none d-lg-inline-block"><img src="{{ asset('img/logo-papua.png') }}" class="avatar rounded shadow-0 img-fluid bg-dark" alt=""><span>SIM</span> <strong>Laptop</strong></div>
                  <div class="brand-text d-none d-sm-inline-block d-lg-none"><strong>SIML</strong></div></a>
                <!-- Toggle Button-->
